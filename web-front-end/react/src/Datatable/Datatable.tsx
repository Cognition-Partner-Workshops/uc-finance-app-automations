...
export const Datatable = () => {
	...
	// Re-fetch the summary whenever the blotter changes (new trade streamed in)
	const accountSummary = GetAccountSummary(selectedId, tradeRowData.length);
	const statistics = accountSummary?.statistics;
			...
			{hasAccount && (
				<Grid container spacing={2} sx={{ mb: 3 }}>
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							title="Total Trades"
							value={statistics ? statistics.totalTrades.toLocaleString() : '--'}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							...
							value={statistics ? statistics.settledTrades.toLocaleString() : '--'}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							...
							value={statistics ? statistics.pendingTrades.toLocaleString() : '--'}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							title="Net Quantity"
							value={statistics ? statistics.netQuantity.toLocaleString() : '--'}
