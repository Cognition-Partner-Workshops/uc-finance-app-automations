...
export const Datatable = () => {
	...
	const accountSummary = GetAccountSummary(selectedId, tradeRowData);
			...
			{hasAccount && (
				<Grid container spacing={2} sx={{ mb: 3 }}>
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							title="Total Trades"
							value={accountSummary ? accountSummary.totalTrades : '--'}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							...
							value={accountSummary ? accountSummary.settledTrades : '--'}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							...
							value={accountSummary ? accountSummary.pendingTrades : '--'}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							title="Net Quantity"
							value={accountSummary ? accountSummary.netQuantity.toLocaleString() : '--'}
